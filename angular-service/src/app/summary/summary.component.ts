import { Component, EventEmitter, Inject, InjectionToken, Optional, Output, output, Self, SkipSelf } from '@angular/core';
...
export class SummaryComponent {
  ...
  @Output() emitsChange : EventEmitter<any> =  new EventEmitter<any>();
